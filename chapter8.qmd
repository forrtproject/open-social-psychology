...
> [#definition]{#def-socialfacilitation style="color: orchid"} Definition of Social Facilitation
>
...
> [#definition]{#def-dynamogenesis style="color: orchid"} Definition of Dynamogenesis
>
...
> [#definition]{#def-generalizeddrive style="color: orchid"} Definition of Generalized Drive
>
...
> [#definition]{#def-distractionconflicttheory style="color: orchid"} Definition of Distraction-Conflict Theory
>
...
> [#definition]{#def-socialcomparisontheory style="color: orchid"} Definition of Social Comparison Theory
>
