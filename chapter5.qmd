...
Since this study, several hundred follow-up studies, including several multi-lab studies that aimed to replicate the overall finding [@hagger_multilab_2016; @vohs2021] and several meta-analyses [@hagger2010; @carter2014; @dang2017a; @blázquez2017] have been carried out.
...
These studies yielded mixed results, with some seeming to confirm the principles of ego depletion [e.g., @hagger2010 concluding that it was highly unlikely that the ego depletion phenomenon did not exist], while others failed to establish the effect despite relying on data from more than 2000 participants [e.g., @hagger_multilab_2016]. Publication bias has been argued to be high in the literature on ego depletion [ @inzlicht2015], casting doubt on the effect.
...
> [#yourturn]{style="color: green"}
>
> How could you objectively measure the amount of willpower available or drained?
