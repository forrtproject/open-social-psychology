...
The first part of this book addresses research that is at the very core of social psychological inquiry. The research contained within asks questions such as "Can people predict the future?" (Chapter on [Feeling the Future](chapter6.qmd)), "Can believing in someone's success make them more successful?" (Chapter on the [Pygmalion Effect](chapter2.qmd)), or "Can humans run out of self-control?" (Chapter on [Ego Depletion](chapter5.qmd)). 
